...
#'
#' Wrapper function for C++ code to evaluate a moving standard deviation over each row for a matrix X. Equivalent to MATLAB's 'movstd' function
#'
